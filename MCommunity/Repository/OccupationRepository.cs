...
namespace MCommunity.Repository
{
     ...
     * 类 名 称:	OccupationRepository
     * 机器名称:	LUMIA800
     * 命名空间:	MCommunity.Repository
     * 文 件 名:	OccupationRepository
     * 创建时间:	2013/3/19 16:14:10
     * 作    者:	常伟华 Changweihua
	 * 版    权:	本代码版权归常伟华所有 All Rights Reserved (C) 2013 - 2014
     * 签    名:	To be or not, it is not a problem !
     * 网    站:	http://www.cmono.net
     * 邮    箱:	changweihua@outlook.com  
     * 唯一标识:	6019fefa-7fb2-4a27-91dc-6caf140eff18  
	 *
	 * 登录用户:	Changweihua
	 * 所 属 域:	Lumia800
    ...
    {
        public OccupationRepository(DbContext db)
            : base(db)
        { }
